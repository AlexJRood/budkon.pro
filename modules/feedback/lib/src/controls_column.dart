...
/// is active.
class ControlsColumn extends ConsumerWidget {
        ...
        children: <Widget>[
          ...
          RotatedBox(
            ...
            child: MaterialButton(
              ...
              child: Text(FeedbackLocalizations.of(context).navigate, style: TextStyle(color: theme.textColor)),
            ),
          ),
          _ColumnDivider(),
          RotatedBox(
            ...
            child: MaterialButton(
              ...
              child: Text(FeedbackLocalizations.of(context).draw,style: TextStyle(
          ...
          IconButton(
            ...
            icon:  Icon(Icons.undo, color: theme.textColor),
            onPressed: isNavigatingActive ? null : onUndo,
          ),
          IconButton(
            key: const ValueKey<String>('clear_button'),
            icon:  Icon(Icons.delete, color: theme.textColor),
