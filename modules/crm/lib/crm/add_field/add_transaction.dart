...
import 'package:crm/crm/add_field/add_filters_section.dart';
...
class AddTransactionFormState extends ConsumerState<AddTransactionForm> with AutomaticKeepAliveClientMixin{
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Material(
                    color: Colors.transparent,
                    child: Text('transaction_data_title'.tr,
                        style: AppTextStyles.houslyAiLogo24)),
                const SizedBox(
                  height: 20,
                ),
