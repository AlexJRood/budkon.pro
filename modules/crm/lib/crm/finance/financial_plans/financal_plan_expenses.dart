import 'package:crm/crm/finance/features/expenses/functions_expenses.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          availableYearsAsync.when(
            ...
            error:
                (error, stack) => Center(child: Text('Error loading years'.tr)),
          ),
