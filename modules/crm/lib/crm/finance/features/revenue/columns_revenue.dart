...
import 'package:crm/crm/finance/features/revenue/revenue_card.dart';
...
class DraggableColumn extends StatelessWidget {
  final String status;
  final List<AgentRevenueModel> revenues;
  final void Function(String status) onAcceptColumn;
  final void Function(AgentRevenueModel transaction, int newIndex) onReorder;
  final void Function(
  ...
  onMove;
  final WidgetRef ref;
  final void Function(AgentRevenueModel transaction)
  ...
  Widget build(BuildContext context) {
    ...
    return DndSender(
      payload: DndPayload(
        type: DndPayloadType.revenueColumnHeader,
        id: status,
      ...
      child: Row(
        children: [
          ...
          DndReceiver(
            ...
            targets: const [DndTargetType.revenueColumn],
            showPreview: false,
            ...
            onDrop: (payload) {
              ...
              if (payload.action == 'move_to_column') {
                final transaction =
                    payload.data!['transaction'] as AgentRevenueModel;
                ...
                children: [
                            ...
                            return Stack(
                              children: [
                                PieMenu(
                                  ...
                                  child: DndReceiver(
                                    showSnackbar: false,
                                    targets: const [DndTargetType.revenueCard],
                                    showHoverFeedback: false,
                                    onDrop: (payload) {
                                      final incomingTransaction =
                                          payload.data!['transaction']
                                              as AgentRevenueModel;
                                      onMove(
                                        incomingTransaction,
                                        status,
                                        index,
                                    ...
                                    child: DndSender(
                                      payload: DndPayload(
                                        type: DndPayloadType.revenue,
                                        id: transaction.id.toString(),
                                        action: 'move_to_column',
                                        subActions: ['assign_revenue'],
                                ...
                                //     onPressed: () {
                                //       debugPrint('Mahdi: IconButton onPressed');
                                //     },
                                //   ),
                                // ),
                              ],
                  ...
                  DndReceiver(
                    ...
                    onDrop: (payload) {
                      final incomingTransaction =
                          payload.data!['transaction'] as AgentRevenueModel;
                      onMove(incomingTransaction, status, revenues.length);
                    },
