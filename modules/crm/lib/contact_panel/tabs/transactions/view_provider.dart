...
import 'package:crm/contact_panel/tabs/transactions/transaction_docs_view.dart'
    show
        TransactionType,
        TransactionViewMode; // use the ONE enum from your enum.dart
    ...
    final List<_Option> cardOptions =
        (type == TransactionType.buy)
            ...
            ? const [
              ...
              _Option(
                label: 'Your agent',
                value: TransactionViewMode.yourAgent,
                icon: AppIcons.share,
              ),
            ]
            : const [
              ...
              _Option(
                label: 'Details',
                value: TransactionViewMode.detailsDraft,
                icon: AppIcons.gridView,
              ),
              _Option(
                label: 'Note',
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                ...
                child: Row(spacing: 4, children: [...leftButtons]),
              ),
            ),
