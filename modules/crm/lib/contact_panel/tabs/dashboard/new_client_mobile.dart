...
class NewClientMobile extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<NewClientMobile> createState() => _NewClientMobileState();
}

class _NewClientMobileState extends ConsumerState<NewClientMobile> {
  @override
  void initState() {
    super.initState();
  ...
  @override
  void didUpdateWidget(covariant NewClientMobile oldWidget) {
