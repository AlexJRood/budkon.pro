...
class NewClientListMobile extends ConsumerStatefulWidget {
  const NewClientListMobile({super.key});

  @override
  ConsumerState<NewClientListMobile> createState() =>
      _NewClientListMobileState();
}

class _NewClientListMobileState extends ConsumerState<NewClientListMobile> {
