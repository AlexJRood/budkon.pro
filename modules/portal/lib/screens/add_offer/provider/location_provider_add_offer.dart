...
class LocationStateAddOffer {
  ...
  LocationStateAddOffer copyWith({
...
class LocationNotifierAddOffer extends StateNotifier<LocationStateAddOffer> {
  LocationNotifierAddOffer() : super(LocationStateAddOffer()) {
    log("📦 LocationNotifierAddOffer initialized: Loading countries...");
...
final locationProviderAddOffer =
    StateNotifierProvider<LocationNotifierAddOffer, LocationStateAddOffer>(
  (ref) => LocationNotifierAddOffer(),
);
