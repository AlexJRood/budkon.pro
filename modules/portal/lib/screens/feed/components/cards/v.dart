  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final isCompactCard = aspectRatio <= 1.3;
        final vPadding = isCompactCard ? base * 0.5 : base;
        final gapScale = isCompactCard ? 0.6 : 1.0;
            ...
            child: PieMenu(
              ...
              onPressedWithDevice: (kind) {
                if (kind == PointerDeviceKind.mouse ||
                  ...
                  debugPrint('Younis check : ${'$path/offer/${ad.slug}'}');
                  // if (isFeed == true) {
                                  ...
                                  child: Material(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        if (isArchive)
                                          SizedBox(height: basePadding / 2 * gapScale),
                                        ...
                                        SizedBox(height: basePadding * gapScale),
                                        Row(
                                          mainAxisAlignment:
