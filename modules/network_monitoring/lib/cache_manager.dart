...
class NetworkMonitoringCacheManagerAdsDetail {
  static final CacheManager instance = CacheManager(
    Config(
      'NetworkMonitoringCacheManagerAdsDetail',
      stalePeriod: const Duration(days: 14),
      maxNrOfCacheObjects: 500,
      repo: JsonCacheInfoRepository(databaseName: 'NetworkMonitoringCacheManagerAdsDetail'),
      fileService: HttpFileService(),
    ),
  );
}

class NetworkMonitoringCacheManagerFeedAds {
  static final CacheManager instance = CacheManager(
    Config(
      'NetworkMonitoringCacheManagerFeedAds',
      stalePeriod: const Duration(days: 14),
      maxNrOfCacheObjects: 500,
      repo: JsonCacheInfoRepository(databaseName: 'NetworkMonitoringCacheManagerFeedAds'),
      fileService: HttpFileService(),
    ),
  );
}
