...
class PropertyComparisonDialog extends ConsumerWidget {
  final bool isMobile;

  PropertyComparisonDialog({super.key, this.isMobile = false});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final double dialogWidth =
        screenWidth <= 1920
            ? 500
            : math.min(1000, 700 + (screenWidth - 1920) * 0.1);
    ...
    return Center(
      child: Dialog(
        ...
        child: BackdropFilter(
          ...
          child: Container(
            width: dialogWidth,
            height: isMobile ? dialogHeight + 100 : dialogHeight,
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 16),
                // Selected properties images with increased width and cyan border
                Consumer(
                  builder: (context, ref, child) {
                    final selectedIds = ref.watch(selectedPropertyIdsProvider);
                    ...
                    final selectedProps =
                        pagingController.itemList
                            ?.where(
                              (property) => selectedIds.contains(property.id),
                            )
                            .toList() ??
                        [];
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    filled: true,
                    fillColor: CustomColors.secondaryWidgetTextColor(
                      context,
                      ref,
                    ).withAlpha(26),
                        ...
                        builderDelegate: PagedChildBuilderDelegate<Property>(
                          itemBuilder: (context, property, index) {
                            ...
                            return GestureDetector(
                              onTap: () {
                                ref
                                    .read(selectedPropertyIdsProvider.notifier)
                    ...
                    Consumer(
                      builder: (context, ref, child) {
                        ...
                        return CustomElevatedButton(
                          ...
                          ? () {
                              // Build URL with exactly 3 report IDs
                              String url = '/compare/${selectedIds[0]}/${selectedIds[1]}/${selectedIds[2]}';
