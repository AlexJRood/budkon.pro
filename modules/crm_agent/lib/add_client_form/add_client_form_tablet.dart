...
class AddClientFormTablet extends ConsumerStatefulWidget {
  final bool isClientView;
  final String? state;
  final bool isNamedRoute;

  const AddClientFormTablet({
    super.key,
  ...
  @override
  ConsumerState<AddClientFormTablet> createState() =>
      _AddClientFormTabletState();
}

class _AddClientFormTabletState extends ConsumerState<AddClientFormTablet> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (selectedTab == 'VIEW'.tr)
                          ...
                          Text('Create a new sell transaction'.tr,
                              style: TextStyle(color: theme.textColor, fontSize: 24, fontWeight: FontWeight.bold))
                        else
                          Text('Create a new buy transaction'.tr,
                              style: TextStyle(color: theme.textColor, fontSize: 24, fontWeight: FontWeight.bold)),
                        ...
                        if (selectedTab == 'VIEW'.tr)
                          ...
                          Text('Select client or create new'.tr,
                              style: TextStyle(color: theme.textColor, fontSize: 17)),
                ...
                Expanded(
                  ...
                  child: NoteAndSubmit(
                    ...
                    onSubmit: () async {
                      ...
                      if (selectedTab == 'VIEW'.tr) {
                        if (!clientOk) return;
                        addClientProvider.estateViewing(ref);
