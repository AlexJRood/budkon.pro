...
class AgentBuyOfferControllers {
  ...
  final TextEditingController minBuildYear;
  final TextEditingController maxBuildYear;
  ...
  AgentBuyOfferControllers(Ref ref)
      :
        ...
        minBuildYear = TextEditingController(text: ref.read(buyOfferFilterCacheProvider)['filters']?['min_build_year']?.toString() ?? ''),
        maxBuildYear = TextEditingController(text: ref.read(buyOfferFilterCacheProvider)['filters']?['max_build_year']?.toString() ?? ''),
  ...
  void dispose() {
    ...
    minBuildYear.dispose();
    maxBuildYear.dispose();
